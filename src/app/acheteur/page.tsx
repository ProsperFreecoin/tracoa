...
import { LeafIcon, ArrowRightIcon, ShieldCheckIcon, PackageIcon, TrendingUpIcon, UsersIcon } from "lucide-react";
  ...
  return (
    <div className="flex flex-col flex-1 pb-10 bg-[#FAF9F6] lg:bg-[#FAF9F6] min-h-screen overflow-y-auto px-5 lg:px-8 pt-8">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          <h1 className="text-2xl lg:text-3xl font-extrabold text-tracao-choco tracking-tight">
            Bonjour, {agriculteur.prenom} {agriculteur.nom || agriculteur.id}
          </h1>
          <p className="text-sm text-tracao-choco-light mt-1">Espace Acheteur Privé</p>
        </div>
        ...
        <div className="min-w-[280px] lg:min-w-[320px] bg-gradient-to-br from-[#4A3018] to-[#6A4524] rounded-[2rem] p-6 text-white shadow-lg relative overflow-hidden snap-start shrink-0 flex flex-col justify-between">
          ...
          <div className="flex justify-between items-start mb-8 relative z-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-base">Lots acquis</h3>
                <p className="text-[10px] text-white/60">Volume total acheté</p>
              </div>
            </div>
          ...
          <div className="relative z-10">
            <div className="flex items-end gap-3 mb-4">
              <span className="text-3xl font-black">45 Lots</span>
            ...
            <Link href="/mes-lots" className="text-sm font-semibold text-white/80 flex justify-between items-center hover:text-white transition-colors">
              Voir le stock <ArrowRightIcon size={16} />
            </Link>
          </div>
        </div>
        ...
        <div className="min-w-[280px] lg:min-w-[320px] bg-white border border-tracao-border-light rounded-[2rem] p-6 text-tracao-choco shadow-sm snap-start shrink-0 flex flex-col justify-between">
          <div className="flex justify-between items-start mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-base">Investissement</h3>
                <p className="text-[10px] text-tracao-choco-pale">Sur la saison en cours</p>
              </div>
            </div>
          </div>
          <div>
            <div className="mb-4">
              <span className="text-3xl font-black">1.2M <span className="text-lg font-bold text-tracao-choco-light">FCFA</span></span>
            </div>
            <div className="text-sm font-semibold text-tracao-choco-pale">
        ...
        <div className="min-w-[280px] lg:min-w-[320px] bg-white border border-tracao-border-light rounded-[2rem] p-6 text-tracao-choco shadow-sm snap-start shrink-0 flex flex-col justify-between">
          <div className="flex justify-between items-start mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-base">Fournisseurs</h3>
                <p className="text-[10px] text-tracao-choco-pale">Producteurs et Coopératives</p>
              </div>
            </div>
          </div>
          <div>
            <div className="mb-4">
              <span className="text-3xl font-black">12 <span className="text-lg font-bold text-tracao-choco-light">actifs</span></span>
            </div>
            <div className="text-sm font-semibold text-tracao-choco-pale flex justify-between items-center">
              Gérer le réseau <ArrowRightIcon size={16} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 text-center text-tracao-choco-pale">
        <p>Interface Acheteur en cours de développement...</p>
      </div>
    </div>
  );
}
